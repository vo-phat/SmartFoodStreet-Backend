...
import backend.repository.StallRepository;
import backend.service.interfaces.IStall;
...
public class StallService implements IStall {
    ...
    public StallResponse create(StallCreateRequest stallCreateRequest) {
        ...
        if (stall.getScript() != null) {
            ...
            stallTranslationService.saveOrUpdate(stall.getId(), "vi-VN", stall.getScript());
        }
    ...
    public StallResponse update(Long id, StallCreateRequest stallCreateRequest) {
        ...
        if (scriptChanged) {
            stallTranslationService.saveOrUpdate(
                    stall.getId(),
                    "vi-VN",
                    stall.getScript()
            );
